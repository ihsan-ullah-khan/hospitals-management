...
(function($) {
   ...
   $('.quantity-right-plus').click(function(e){
	...
	if($('.owl-carousel.our-doctor').length > 0) {
		$('.owl-carousel.our-doctor').owlCarousel({
			loop:true,
			margin:15,
			dots: false,
			nav:true,
	...
	if($('.owl-carousel.best-our-doctor').length > 0) {
		$('.owl-carousel.best-our-doctor').owlCarousel({
			loop:true,
			margin:15,
			dots: false,
			nav:true,
