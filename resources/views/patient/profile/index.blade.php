                    ...
                    <div class="doctor-widget">
                        <div class="doc-info-left">
                            <div class="doctor-img">
                                @if($patient->profile_image ?? '')
                                    <img src="{{ asset('storage/images/' . $patient->profile_image) }}" class="img-fluid" alt="User Image">
                                @else
                        ...
                        <div class="doc-info-right">
                            <div class="clini-infos">
                                <a href="{{ route('profile.edit', $patient) }}" class="edit-pro"><i class="feather-edit"></i> Edit</a>
                            </div>
