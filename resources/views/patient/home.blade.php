                    ...
                    <div class="row">
                        <div class="col-lg-4 mb-3 aos" data-aos="fade-up">
                            <div class="card text-center doctor-book-card">
                                <img src="{{ URL::asset('/assets/img/doctors/doctor-07.jpg')}}" alt="" class="img-fluid">
                                <div class="doctor-book-card-content tile-card-content-1">
                                    <div>
                                        <h3 class="card-title mb-0">Visit a Doctor</h3>
                                        <a href="{{url('search')}}" class="btn book-btn1 px-3 py-2 mt-3 btn-one-light" tabindex="0">Book Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 mb-3 aos" data-aos="fade-up">
                            <div class="card text-center doctor-book-card">
                                <img src="{{ URL::asset('/assets/img/img-pharmacy1.jpg')}}" alt="" class="img-fluid">
                                <div class="doctor-book-card-content tile-card-content-1">
                                    <div>
                                        <h3 class="card-title mb-0">Find a Pharmacy</h3>
                                        <a href="{{url('pharmacy-search')}}" class="btn book-btn1 px-3 py-2 mt-3 btn-one-light" tabindex="0">Find Now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 mb-3 aos" data-aos="fade-up">
                            <div class="card text-center doctor-book-card">
                                <img src="{{ URL::asset('/assets/img/features/feature-04.jpg')}}" alt="" class="img-fluid">
                                <div class="doctor-book-card-content tile-card-content-1">
                                    <div>
                ...
                <div class="col-lg-8">
                    <div class="doctor-slider slider aos" data-aos="fade-up">
                        ...
                        <div class="profile-widget">
                            <div class="doc-img">
                                <a href="{{url('doctor-profile')}}">
                                    <img class="img-fluid" alt="User Image" src="{{ URL::asset('/assets/img/doctors/doctor-01.jpg')}}" style="height: 10rem;">
                                </a>
                        ...
                        <div class="profile-widget">
                            <div class="doc-img">
                                <a href="{{url('doctor-profile')}}">
                                    <img class="img-fluid" alt="User Image" src="{{ URL::asset('/assets/img/doctors/doctor-02.jpg')}}" style="height: 10rem;">
                                </a>
                                <a href="javascript:void(0)" class="fav-btn">
                                    <i class="far fa-bookmark"></i>
                                </a>
                        ...
                        <div class="profile-widget">
                            <div class="doc-img">
                                <a href="{{url('doctor-profile')}}">
                                    <img class="img-fluid" alt="User Image" src="{{ URL::asset('/assets/img/doctors/doctor-03.jpg')}}" style="height: 10rem;">
                                </a>
                                <a href="javascript:void(0)" class="fav-btn">
                                    <i class="far fa-bookmark"></i>
                                </a>
                        ...
                        <div class="profile-widget">
                            <div class="doc-img">
                                <a href="{{url('doctor-profile')}}">
                                    <img class="img-fluid" alt="User Image" src="{{ URL::asset('/assets/img/doctors/doctor-04.jpg')}}" style="height: 10rem;">
                                </a>
                                <a href="javascript:void(0)" class="fav-btn">
                                    <i class="far fa-bookmark"></i>
                                </a>
                        ...
                        <div class="profile-widget">
                            <div class="doc-img">
                                <a href="{{url('doctor-profile')}}">
                                    <img class="img-fluid" alt="User Image" src="{{ URL::asset('/assets/img/doctors/doctor-05.jpg')}}" style="height: 10rem;">
                                </a>
                                <a href="javascript:void(0)" class="fav-btn">
                                    <i class="far fa-bookmark"></i>
                                </a>
                        ...
                        <div class="profile-widget">
                            <div class="doc-img">
                                <a href="{{url('doctor-profile')}}">
                                    <img class="img-fluid" alt="User Image" src="{{ URL::asset('/assets/img/doctors/doctor-06.jpg')}}" style="height: 10rem;">
                                </a>
                                <a href="javascript:void(0)" class="fav-btn">
                                    <i class="far fa-bookmark"></i>
                                </a>
                        ...
                        <div class="profile-widget">
                            <div class="doc-img">
                                <a href="{{url('doctor-profile')}}">
                                    <img class="img-fluid" alt="User Image" src="{{ URL::asset('/assets/img/doctors/doctor-07.jpg')}}" style="height: 10rem;">
                                </a>
                                <a href="javascript:void(0)" class="fav-btn">
                                    <i class="far fa-bookmark"></i>
                                </a>
                        ...
                        <div class="profile-widget">
                            <div class="doc-img">
                                <a href="{{url('doctor-profile')}}">
                                    <img class="img-fluid" alt="User Image" src="{{ URL::asset('/assets/img/doctors/doctor-08.jpg')}}" style="height: 10rem;">
                                </a>
                                <a href="javascript:void(0)" class="fav-btn">
                                    <i class="far fa-bookmark"></i>
                                </a>
                            ...
                            <ul class="entry-meta meta-item">
                                <li>
                                    <div class="post-author">
                                        <a href="{{url('doctor-profile')}}"><img src="{{ URL::asset('/assets/img/doctors/doctor-01.jpg')}}" alt="Post Author"> <span>Dr. Ruby Perrin</span></a>
                                    </div>
                                </li>
                    ...
                    <div class="blog grid-blog">
                        ...
                        <div class="blog-content">
                            <ul class="entry-meta meta-item">
                                <li>
                                    <div class="post-author">
                                        <a href="{{url('doctor-profile')}}"><img src="{{ URL::asset('/assets/img/doctors/doctor-02.jpg')}}" alt="Post Author"> <span>Dr. Darren Elder</span></a>
                                    </div>
                                </li>
                    ...
                    <div class="blog grid-blog">
                        ...
                        <div class="blog-content">
                            <ul class="entry-meta meta-item">
                                <li>
                                    <div class="post-author">
                                        <a href="{{url('doctor-profile')}}"><img src="{{ URL::asset('/assets/img/doctors/doctor-03.jpg')}}" alt="Post Author"> <span>Dr. Deborah Angel</span></a>
                                    </div>
                                </li>
                                <li><i class="far fa-clock"></i> 3 Dec 2019</li>
                            </ul>
                    ...
                    <div class="blog grid-blog">
                        ...
                        <div class="blog-content">
                            <ul class="entry-meta meta-item">
                                <li>
                                    <div class="post-author">
                                        <a href="{{url('doctor-profile')}}"><img src="{{ URL::asset('/assets/img/doctors/doctor-04.jpg')}}" alt="Post Author"> <span>Dr. Sofia Brient</span></a>
                                    </div>
                                </li>
