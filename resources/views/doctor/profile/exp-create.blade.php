                        ...
                        <form method="POST" action="{{ route('experience.store') }}">
                            ...
                            <div class="form-row row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="experience_title" name="experience_title" placeholder="Position of your past work" required>
                                </div>
                                <input type="hidden" name="user_id" value="{{ \Illuminate\Support\Facades\Auth::id() }}">
                                <div class="col-md-6 mb-3">
                                    <label for="company_name">Company Name:</label>
                                    <input type="text" class="form-control" id="company_name" name="company_name" placeholder="Enter company name where you worked before." required>
                                </div>
                            </div>
