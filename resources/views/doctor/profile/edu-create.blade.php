                        ...
                        <form method="POST" action="{{ route('education.store') }}">
                            ...
                            <div class="form-row row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="college_name" name="college_name" placeholder="College / University name" required>
                                </div>
                                <input type="hidden" name="user_id" value="{{ \Illuminate\Support\Facades\Auth::id() }}">
                                <div class="col-md-6 mb-3">
                                    <label for="area">Study area</label>
                                    <input type="text" class="form-control" id="area" name="area" placeholder="Enter your Area of Study" required>
                                </div>
                            </div>
