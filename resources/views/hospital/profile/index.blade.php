                            ...
                            <div class="doc-info-left">
                                <div class="doctor-img">
                                    @if($hospital_admin->profile_image ?? '')
                                        <img src="{{ asset('storage/images/' . $hospital_admin->profile_image) }}" class="img-fluid" alt="User Image">
                                    @else
...
{{--                                    </div>--}}
                            ...
                            <div class="doc-info-right">
                                <div class="clini-infos">
                                    <a href="{{ route('profile.edit', $hospital_admin) }}" class="edit-pro"><i class="feather-edit"></i> Edit</a>
                                </div>
                                                    ...
                                                    <div class="social-icon d-flex justify-content-between mt-2">
                                                        <div>
                                                            @if($hospital_admin->twitter ?? '')
                                                                <a href="{{ $hospital_admin->twitter }}"><i class="feather-twitter"></i></a>
                                                            @else
                                                        ...
                                                        <div>
                                                            @if($hospital_admin->facebook ?? '')
                                                                <a href="{{ $hospital_admin->facebook }}"><i class="feather-facebook"></i></a>
                                                            @else
                                                        ...
                                                        <div>
                                                            @if($hospital_admin->linkedin ?? '')
                                                                <a href="{{ $hospital_admin->linkedin }}"><i class="feather-linkedin"></i></a>
                                                            @else
                                                        ...
                                                        <div>
                                                            @if($hospital_admin->instagram ?? '')
                                                                <a href="{{ $hospital_admin->instagram }}"><i class="feather-instagram"></i></a>
                                                            @else
                                                        ...
                                                        <div>
                                                            @if($hospital_admin->youtube ?? '')
                                                                <a href="{{ $hospital_admin->youtube }}"><i class="feather-youtube"></i></a>
                                                            @else
