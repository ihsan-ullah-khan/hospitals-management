                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-4">
                                            <a href="{{ route('doctor.index') }}" class="dash-widget dct-border-rht">
                                                ...
                                                <div class="dash-widget-info">
                                                    <h6>Total Doctors</h6>
                                                    <h3>{{ count(\App\Models\User::query()->where('hospital_id', \Illuminate\Support\Facades\Auth::user()->hospital_id)->where('user_type', 'D')->get()) }}</h3>
                                        ...
                                        <div class="col-md-12 col-lg-4">
                                            <a href="{{ route('patient.index') }}" class="dash-widget dct-border-rht">
                                                ...
                                                <div class="dash-widget-info">
                                                    <h6>Total Patient</h6>
                                                    <h3>{{ count(\App\Models\User::query()->where('hospital_id', \Illuminate\Support\Facades\Auth::user()->hospital_id)->where('user_type', 'U')->get()) }}</h3>
