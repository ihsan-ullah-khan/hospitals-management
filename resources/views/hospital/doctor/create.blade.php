                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('doctor.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="name" name="name" type="text" class="form-control" placeholder="Enter doctor name">
                                </div>
                            </div>
                            <!-- Email -->
                            <div class="form-group row">
                                ...
                                <div class="col-md-10">
                                    <input id="email" name="email" type="text" class="form-control" placeholder="Enter doctor email">
                                </div>
                            </div>
                            <!-- type -->
                            ...
                            <button class="btn btn-primary btn-add" ><i class="feather-plus-square me-1"></i> Add Doctor</button>
                        </form>
                    </div>
                </div>
            </div>
