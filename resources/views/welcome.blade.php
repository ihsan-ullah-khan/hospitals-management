									...
									<div class="card text-center doctor-book-card">
										...
										<div class="doctor-book-card-content tile-card-content-1">
											<div>
												...
												<a href="#" class="btn book-btn1 px-3 py-2 mt-3 btn-one-light" tabindex="0">Book Now</a>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-lg-8">
							<div class="doctor-slider slider aos" data-aos="fade-up">
								...
								<div class="profile-widget">
									<div class="doc-img">
										<a href="#">
											<img class="img-fluid" alt="User Image" src="{{ asset('/assets/img/doctors/doctor-01.jpg')}}" style="height:10rem;">
										</a>
								...
								<div class="profile-widget">
									<div class="doc-img">
										<a href="#">
											<img class="img-fluid" alt="User Image" src="{{ asset('/assets/img/doctors/doctor-02.jpg')}}" style="height:10rem;">
										</a>
										<a href="javascript:void(0)" class="fav-btn">
											<i class="far fa-bookmark"></i>
										</a>
