                            ...
                            <div class="profile-detail">
                                <label class="avatar profile-cover-avatar">
                                    @if($admin->profile_image ?? '')
                                        <img class="avatar-img" src="{{ asset('storage/images/' . $admin->profile_image) }}" alt="Profile Image">
                                    @else
                                ...
                                <a href="{{ route('profile.edit', $admin) }}" class="edit-pro"><i class="feather-edit"></i> Edit</a>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
