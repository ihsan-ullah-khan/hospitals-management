									...
									<div class="dash-widget-header">
										...
										<div class="dash-count">
											...
											<div class="dash-counts">
												<p>{{ count(\App\Models\Hospital::all()) }}</p>
											</div>
										</div>
									</div>
                                ...
                                <a href="{{ route('speciality.index') }}" class="card-body">
                                    <div class="dash-widget-header">
                                        ...
                                        <div class="dash-count">
                                            ...
                                            <div class="dash-counts">
                                                <p>{{ count(\App\Models\Speciality::all()) }}</p>
                                            </div>
                                        </div>
                                    </div>
{{--                                    <p class="trade-level mb-0"><span class="text-danger me-1"><i class="fas fa-caret-down me-1"></i>1.15%</span> last week</p>--}}
                                ...
                                <a href="{{ route('doctor.index') }}" class="card-body">
                                    <div class="dash-widget-header">
                                        ...
                                        <div class="dash-count">
                                            ...
                                            <div class="dash-counts">
                                                <p>{{ count(\App\Models\User::query()->where('user_type', 'D')->get()) }}</p>
                                            </div>
                                        </div>
                                    </div>
{{--                                    <p class="trade-level mb-0"><span class="text-danger me-1"><i class="fas fa-caret-down me-1"></i>1.15%</span> last week</p>--}}
								...
								<a href="{{ route('patient.index') }}" class="card-body">
									<div class="dash-widget-header">
										...
										<div class="dash-count">
											...
											<div class="dash-counts">
												<p>{{ count(\App\Models\User::query()->where('user_type', 'U')->get()) }}</p>
											</div>
										</div>
									</div>
									...
									<div class="appointment-item">
										...
										<div class="app-user">
											<div class="row">
												<div class="col-sm-6">
													<div class="app-img">
														<img src="{{ URL::asset('/assets_admin/img/profiles/avatar-02.jpg')}}" alt="" class="img-fluid">
														<div class="app-name">
															<h6>Dr. Lester </h6>
															<p>Orthopaedics</p>
														</div>
												...
												<div class="col-sm-6">
													<div class="app-img justify-content-sm-end">
														<img src="{{ URL::asset('/assets_admin/img/profiles/avatar-05.jpg')}}" alt="" class="img-fluid">
														<div class="app-name">
															<h6>Chris Harris</h6>
															<p>ID : 781212, M</p>
														</div>
									...
									<div class="appointment-item">
										...
										<div class="app-user">
											<div class="row">
												<div class="col-sm-6">
													<div class="app-img">
														<img src="{{ URL::asset('/assets_admin/img/profiles/avatar-06.jpg')}}" alt="" class="img-fluid">
														<div class="app-name">
															<h6>Dr. Monroe</h6>
												...
												<div class="col-sm-6">
													<div class="app-img justify-content-sm-end">
														<img src="{{ URL::asset('/assets_admin/img/profiles/avatar-07.jpg')}}" alt="" class="img-fluid">
														<div class="app-name">
															<h6>Bess Twishes</h6>
															<p>ID : 787787, M</p>
														</div>
									...
									<div class="appointment-item">
										...
										<div class="app-user">
											<div class="row">
												...
												<div class="col-sm-6">
													<div class="app-img justify-content-sm-end">
														<img src="{{ URL::asset('/assets_admin/img/profiles/avatar-08.jpg')}}" alt="" class="img-fluid">
														<div class="app-name">
															<h6>James Aaron</h6>
															<p>ID : 781212, M</p>
														</div>
										...
										<table class="table doc-table">
											<tbody>
												<tr>
													<td>
														<h2 class="table-avatar">
															<a class="avatar-pos avatar-online" href="{{url('admin/profile')}}"><img class="avatar avatar-img" src="{{ URL::asset('/assets_admin/img/profiles/avatar-05.jpg')}}" alt="User Image"></a>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a class="avatar-pos avatar-online" href="{{url('admin/profile')}}"><img class="avatar avatar-img" src="{{ URL::asset('/assets_admin/img/profiles/avatar-10.jpg')}}" alt="User Image"></a>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a class="avatar-pos avatar-offline" href="{{url('admin/profile')}}"><img class="avatar avatar-img" src="{{ URL::asset('/assets_admin/img/profiles/avatar-11.jpg')}}" alt="User Image"></a>
												...
												<tr>
													<td>
														<h2 class="table-avatar">
															<a class="avatar-pos avatar-offline" href="{{url('admin/profile')}}"><img class="avatar avatar-img" src="{{ URL::asset('/assets_admin/img/profiles/avatar-13.jpg')}}" alt="User Image"></a>
										...
										<table class="table table-borderless">
											<tbody>
												<tr class="speciality-item">
													<td class="spl-name">
														<div class="spl-box">
															<img src="{{ URL::asset('/assets_admin/img/icon/urology.png')}}" alt="User Image">
														</div>
														<div class="spl-count">
															<h6>Urology</h6>
															<p>Patients : 400</p>
												...
												<tr class="speciality-item">
													<td class="spl-name">
														<div class="spl-box">
															<img src="{{ URL::asset('/assets_admin/img/icon/neurology.png')}}" alt="User Image">
														</div>
														<div class="spl-count">
															<h6>Neurology</h6>
															<p>Patients : 980 </p>
												...
												<tr class="speciality-item">
													<td class="spl-name">
														<div class="spl-box">
															<img src="{{ URL::asset('/assets_admin/img/icon/ortho.png')}}" alt="User Image">
														</div>
														<div class="spl-count">
															<h6>Orthopedic</h6>
															<p>Patients : 600</p>
												...
												<tr class="speciality-item">
													<td class="spl-name">
														<div class="spl-box">
															<img src="{{ URL::asset('/assets_admin/img/icon/cardio.png')}}" alt="User Image">
														</div>
														<div class="spl-count">
															<h6>Urology</h6>
															<p>Patients : 400</p>
												...
												<tr class="speciality-item">
													<td class="spl-name">
														<div class="spl-box">
															<img src="{{ URL::asset('/assets_admin/img/icon/dental.png')}}" alt="User Image">
														</div>
														<div class="spl-count">
															<h6>Urology</h6>
															<p>Patients : 400</p>
											...
											<div class="pricing-carousel owl-carousel owl-theme">
												<div class="item">
													<div class="price-list active">
														<a class="active" data-bs-toggle="tab" href="{{url('#home')}}">
															Sun
															<span>28th</span>
														</a>
													</div>
												...
												<div class="item">
													<div class="nav-item price-list">
														<a data-bs-toggle="tab" href="{{url('#menu1')}}">
															Mon
															<span>28th</span>
														</a>
													</div>
												...
												<div class="item">
													<div class="price-list">
														<a data-bs-toggle="tab" href="{{url('#menu2')}}">
															 Tue
												...
												<div class="item">
													<div class="price-list">
														<a data-bs-toggle="tab" href="{{url('#menu3')}}">
															Wed
															<span>1st</span>
														</a>
													</div>
												...
												<div class="item">
													<div class="price-list">
														<a data-bs-toggle="tab" href="{{url('#menu4')}}">
															Thu
															<span>2nd</span>
														</a>
													</div>
											...
											<div class="appointment-items">
												<div class="app-user">
													<div class="row">
														<div class="col-sm-6">
															<div class="app-img">
																<img src="{{ URL::asset('/assets_admin/img/profiles/avatar-09.jpg')}}" alt="" class="img-fluid">
																<div class="app-name">
																	<h6>Dr. Rayan </h6>
																	<p>Orthopaedics</p>
																</div>
														...
														<div class="col-sm-6">
															<div class="app-img">
																<img src="{{ URL::asset('/assets_admin/img/profiles/avatar-13.jpg')}}" alt="" class="img-fluid">
																<div class="app-name">
																	<h6>Chris Harris</h6>
																	<p>ID : 781212, M</p>
																</div>
											...
											<div class="appointment-items">
												<div class="app-user">
													<div class="row">
														<div class="col-6">
															<div class="app-img">
																<img src="{{ URL::asset('/assets_admin/img/profiles/avatar-12.jpg')}}" alt="" class="img-fluid">
																<div class="app-name">
																	<h6>Dr. Alex </h6>
																	<p>Orthopaedics</p>
																</div>
											...
											<div class="appointment-items">
												<div class="app-user">
													<div class="row">
														<div class="col-6">
															<div class="app-img">
																<img src="{{ URL::asset('/assets_admin/img/profiles/avatar-03.jpg')}}" alt="" class="img-fluid">
																<div class="app-name">
																	<h6>Dr. Shofia </h6>
																	<p>Orthopaedics</p>
																</div>
														...
														<div class="col-6">
															<div class="app-img">
																<img src="{{ URL::asset('/assets_admin/img/profiles/avatar-10.jpg')}}" alt="" class="img-fluid">
																<div class="app-name">
																	<h6>Harris Chris</h6>
																	<p>ID : 781212, M</p>
																</div>
					...
					<div class="row">
							...
							<div class="card">
								...
								<div class="card-body">
									<div class="country-item">
										<div class="con-name">
											<div class="flag-box">
												<img class="rounded-circle" src="{{ URL::asset('/assets_admin/img/flags/flag-01.png')}}" alt="User Image">
											</div>
											<div class="flag-name">
									...
									<div class="country-item">
										<div class="con-name">
											<div class="flag-box">
												<img class="rounded-circle" src="{{ URL::asset('/assets_admin/img/flags/flag-02.png')}}" alt="User Image">
											</div>
											<div class="flag-name">
									...
									<div class="country-item">
										<div class="con-name">
											<div class="flag-box">
												<img class="rounded-circle" src="{{ URL::asset('/assets_admin/img/flags/flag-03.png')}}" alt="User Image">
											</div>
											<div class="flag-name">
									...
									<div class="country-item">
										<div class="con-name">
											<div class="flag-box">
												<img class="rounded-circle" src="{{ URL::asset('/assets_admin/img/flags/flag-04.png')}}" alt="User Image">
											</div>
											<div class="flag-name">
									...
									<div class="country-item">
										<div class="con-name">
											<div class="flag-box">
												<img class="rounded-circle" src="{{ URL::asset('/assets_admin/img/flags/flag-05.png')}}" alt="User Image">
											</div>
											<div class="flag-name">
												<p class="user-name"><span>UAE</span> <span class="d-block text-muted">300 Patients</span></p>
											</div>
						...
						<div class="col-xl-4">
							<div class="row">
								...
								<div class="col-sm-6 d-flex">
									<div class="spl-items flex-fill">
										<a href="{{url('admin/upcoming-appointments')}}">
