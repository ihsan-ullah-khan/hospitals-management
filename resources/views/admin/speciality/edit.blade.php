                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('speciality.update', $speciality) }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-10">
                                        <input id="name" name="name" type="text" value="{{ $speciality->name }}" class="form-control" placeholder="Enter Speciality name">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <button class="btn btn-primary btn-add" ><i class="feather-plus-square me-1"></i> Add Speciality</button>
                            </form>
                        </div>
                    </div>
                </div>
