    ...
    <div class="page-header">
        <div class="row align-items-center">
            <div class="col-md-12 d-flex justify-content-end">
                <div class="doc-badge me-3">Specialities <span class="ms-1">{{ count($specialities) }}</span></div>
                <a href="{{ route('speciality.create') }}" class="btn btn-primary btn-add"><i class="feather-plus-square me-1"></i> Add New</a>
            </div>
        </div>
    </div>
                    ...
                    <div class="table-responsive">
                        <table class="datatable table table-borderless hover-table" id="data-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="#" class="spl-img"><img
                                                src="{{ asset('storage/images/' . $speciality->image) }}"
                                ...
                                <td class="text-end">
                                    <div class="actions">
                                        <a class="text-black" href="{{ route('speciality.edit', $speciality) }}" >
                                ...
                                <form method="POST" id="delete{{ $speciality->id }}" action="{{ route('speciality.destroy', $speciality) }}">
                                    @csrf
                                    @method('delete')
                                </form>
                            </tr>
