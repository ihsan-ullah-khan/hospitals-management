                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h2 class="table-avatar">
                                                    <a class="avatar-pos" href="#" data-bs-target="#doctorlist" data-bs-toggle="modal"><img class="avatar avatar-img" src="{{ asset('storage/images/' . $doctor->profile_image) }}" alt="User Image"></a>
                                                    <a href="#" data-bs-target="#doctorlist" data-bs-toggle="modal" class="user-name">Dr. {{ $doctor->name }}</a>
                                                </h2>
                                            </td>
                                            ...
                                            <td class="text-end">
                                                <div class="actions">
                                                    <a class="text-black" href="{{ route('hospitalDoctors.edit', $doctor) }}" >
                                            ...
                                            <form method="POST" id="delete{{ $doctor->id }}" action="{{ route('hospitalDoctors.destroy', $doctor) }}">
                                                @csrf
                                                @method('delete')
                                            </form>
                                        </tr>
