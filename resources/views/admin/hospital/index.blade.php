            ...
            <div class="page-header">
                <div class="row align-items-center">
                    <div class="col-md-12 d-flex justify-content-end">
                        ...
                        <a href="{{ route('hospital.create') }}" class="btn btn-primary btn-add"><i class="feather-plus-square me-1"></i> Add New</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="table-responsive">
                        <table class="datatable table table-borderless hover-table" id="data-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="#" class="spl-img"><img
                                                src="{{ asset('storage/images/' . $hospital->image) }}"
                                ...
                                <td class="text-end">
                                    <div class="actions">
                                        <a class="text-black" href="{{ route('hospital.show', $hospital) }}" >
                                            <i class="feather-show-3 me-1"></i> See doctors
                                        </a>
                                        <a class="text-black" href="{{ route('hospital.edit', $hospital) }}" >
                                ...
                                <form method="POST" id="delete{{ $hospital->id }}" action="{{ route('hospital.destroy', $hospital) }}">
                                    @csrf
                                    @method('delete')
                                </form>
                            </tr>
